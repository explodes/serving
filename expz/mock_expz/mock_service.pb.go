...
// Source: github.com/explodes/serving/expz (interfaces: ExpzServiceClient,Client)
...
// GetExperiments mocks base method
func (m *MockClient) GetExperiments(arg0 context.Context, arg1 string) (expz.ExperimentFlags, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExperiments", arg0, arg1)
	ret0, _ := ret[0].(expz.ExperimentFlags)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetExperiments indicates an expected call of GetExperiments
func (mr *MockClientMockRecorder) GetExperiments(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetExperiments", reflect.TypeOf((*MockClient)(nil).GetExperiments), arg0, arg1)
}
